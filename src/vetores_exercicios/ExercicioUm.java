...
//		que vão alugar quartos (N pode ser de 1 a 10). Em seguida, registre o aluguel dos N estudantes. Para cada registro de aluguel, informar o nome e email do
...
//		um relatório de todas ocupações do pensionato, por ordem de quarto.\
		...
		for (int i = 1; i < vect.length; i++) {
			...
			int room = sc.nextInt();
			vect[room] = new Alunos(name, email);
		}
